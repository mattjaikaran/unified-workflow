...
GSD executors run self-check per plan. Enhancement for unified workflow:
...
3. **REQUIRED SUB-SKILL:** `requesting-code-review` — review code quality
4. **REQUIRED SUB-SKILL:** `finishing-a-development-branch` — merge/PR decision
